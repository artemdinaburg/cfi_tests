...
/usr/local/osquery/bin/clang++  -I/usr/local/osquery/include -I. -Os ${ARGS} -c -o registry_Os.o registry.cpp
/usr/local/osquery/bin/clang++  -I/usr/local/osquery/include -I. -O0 ${ARGS} -c -o registry_O0.o registry.cpp
/usr/local/osquery/bin/clang++  -L/usr/local/osquery/lib -I/usr/local/osquery/include -I. ${LINKARGS} -o cfi_Os config.o registry_Os.o ${LINKARGS2}
/usr/local/osquery/bin/clang++  -L/usr/local/osquery/lib -I/usr/local/osquery/include -I. ${LINKARGS} -o cfi_O0 config.o registry_O0.o ${LINKARGS2}
